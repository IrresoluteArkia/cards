...
public class CraftingHandler {
	...
	public static void init(){
		GameRegistry.addShapedRecipe(new ResourceLocation("recards:recipe1"), new ResourceLocation("recipes"), ItemCardSelectorTiered.getCardSelectorWithTier(1), new Object[]{"PPP", "PEP", "PPP", 'E', Blocks.EMERALD_BLOCK, 'P', Items.PAPER});
